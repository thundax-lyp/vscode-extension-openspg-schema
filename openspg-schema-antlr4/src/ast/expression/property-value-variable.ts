...
export type PropertyValueVariableNode = BuiltinPropertyValue | BlockPropertyValue | BasicPropertyValue;
...
export class PropertyValueVariable extends BaseNodeUnion<
    BuiltinPropertyValue | BlockPropertyValue | BasicPropertyValue
> {
    constructor(ctx: PropertyValueVariableContext, visitor: SchemaParserVisitor<any>) {
        super(ctx, [ctx.builtinPropertyValue(), ctx.blockPropertyValue(), ctx.basicPropertyValue()], visitor);
    }
}
