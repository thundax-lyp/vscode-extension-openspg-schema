...
export type StructureTypeExpressionNode = BasicStructureTypeExpression | InheritedStructureTypeExpression;
...
export class StructureTypeExpression extends BaseNodeUnion<
    BasicStructureTypeExpression | InheritedStructureTypeExpression
> {
    constructor(ctx: StructureTypeExpressionContext, visitor: SchemaParserVisitor<any>) {
        super(ctx, [ctx.basicStructureTypeExpression(), ctx.inheritedStructureTypeExpression()], visitor);
    }
}
