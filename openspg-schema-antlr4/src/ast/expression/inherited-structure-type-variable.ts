...
export class InheritedStructureTypeVariable extends BaseNodeUnion<
    KnowledgeStructureType | StandardStructureType | VariableStructureTypeNode
> {
    constructor(ctx: InheritedStructureTypeVariableContext, visitor: SchemaParserVisitor<any>) {
        super(ctx, [ctx.knowledgeStructureType(), ctx.standardStructureType(), ctx.variableStructureType()], visitor);
    }
}
