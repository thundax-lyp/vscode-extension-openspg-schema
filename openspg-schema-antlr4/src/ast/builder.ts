...
export class SchemaASTBuilder extends parser.SchemaParserVisitor<ast.SyntaxNode | any> {
    ...
    visitBasicStructureDeclaration = (ctx: parser.BasicStructureDeclarationContext) =>
        new ast.BasicStructureDeclaration(ctx, this);

    visitStructureNameExpression = (ctx: parser.StructureNameExpressionContext) =>
        new ast.StructureNameExpression(ctx, this);
    ...
    visitStructureAliasExpression = (ctx: parser.StructureAliasExpressionContext) =>
        new ast.StructureAliasExpression(ctx, this);

    visitStructureAlias = (ctx: parser.StructureAliasContext) => new ast.StructureAlias(ctx, this);

    visitStructureTypeExpression = (ctx: parser.StructureTypeExpressionContext) =>
        new ast.StructureTypeExpression(ctx, this);

    visitBasicStructureTypeExpression = (ctx: parser.BasicStructureTypeExpressionContext) =>
        new ast.BasicStructureTypeExpression(ctx, this);

    visitBasicStructureTypeVariable = (ctx: parser.BasicStructureTypeVariableContext) =>
        new ast.BasicStructureTypeVariable(ctx, this);

    visitInheritedStructureTypeExpression = (ctx: parser.InheritedStructureTypeExpressionContext) =>
        new ast.InheritedStructureTypeExpression(ctx, this);

    visitInheritedStructureTypeVariable = (ctx: parser.InheritedStructureTypeVariableContext) =>
        new ast.InheritedStructureTypeVariable(ctx, this);

    visitKnowledgeStructureType = (ctx: parser.KnowledgeStructureTypeContext) =>
        new ast.KnowledgeStructureType(ctx, this);
    ...
    visitBasicPropertyDeclaration = (ctx: parser.BasicPropertyDeclarationContext) =>
        new ast.BasicPropertyDeclaration(ctx, this);

    visitPropertyNameExpression = (ctx: parser.PropertyNameExpressionContext) =>
        new ast.PropertyNameExpression(ctx, this);
    ...
    visitPropertyValueExpression = (ctx: parser.PropertyValueExpressionContext) =>
        new ast.PropertyValueExpression(ctx, this);
