...
export type OnDocumentOnTypeFormatting = Parameters<Connection['onDocumentOnTypeFormatting']>[0];
export type OnDocumentRangeFormatting = Parameters<Connection['onDocumentRangeFormatting']>[0];
