...
import { ConceptRuleParserVisitor, ParserRuleContext, ParseTree } from "../antlr4";
...
export abstract class BaseNodeList<T extends any = BaseNode> extends Array<T> {
    constructor(
        ...
        visitor: ConceptRuleParserVisitor<any>,
...
export abstract class BaseNodeUnion<T extends BaseNode | BaseNodeList<BaseNode> = BaseNode> extends BaseNode {
    constructor(_ctx: ParserRuleContext, list: (ParseTree | null)[] | null, visitor: ConceptRuleParserVisitor<any>) {
        super(_ctx, visitor);
