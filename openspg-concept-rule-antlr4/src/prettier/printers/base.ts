...
export const lineComments: SyntaxTokenType[] = ["LINE_COMMENT"];
export const blockComments: SyntaxTokenType[] = ["BLOCK_COMMENT"];
...
export class BasePrinter {
    ...
    tuple = (
        ...
        return this.builders.group(["(", this.builders.indentIfBreak(line, { groupId }), content, line, ")"], {
            id: groupId,
            shouldBreak
        });
    };
